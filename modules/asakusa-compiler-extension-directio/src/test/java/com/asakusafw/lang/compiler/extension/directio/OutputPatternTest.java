...
public class OutputPatternTest {
    ...
    final DataModelReference dataClass = MockDataModelLoader.load(MockData.class);
    ...
    @Test
    public void simple() {
        OutputPattern compiled = OutputPattern.compile(dataClass, "hello", list("intValue"));

        List<CompiledSegment> segments = compiled.getResourcePattern();
        assertThat(segments.size(), is(1));
        assertThat(segments.get(0).getFormat(), is(Format.PLAIN));
        assertThat(segments.get(0).getArgument(), is("hello"));

        List<CompiledOrder> orders = compiled.getOrders();
        assertThat(orders.size(), is(1));
        assertThat(orders.get(0).getTarget().getName(), is(PropertyName.of("intValue")));
        assertThat(orders.get(0).isAscend(), is(true));
    }
    ...
    public void resource_placeholder_date() {
        ...
        assertThat(pattern.size(), is(1));
        assertThat(pattern.get(0).getTarget().getName(), is(PropertyName.of("dateValue")));
    ...
    public void resource_placeholder_datetime() {
        ...
        assertThat(pattern.size(), is(1));
        assertThat(pattern.get(0).getTarget().getName(), is(PropertyName.of("datetimeValue")));
    ...
    public void resource_placeholder_mixed() {
        ...
        assertThat(pattern.get(1).getTarget().getName(), is(PropertyName.of("intValue")));
    ...
    public void resource_wildcard() {
        List<CompiledSegment> pattern = OutputPattern.compileResourcePattern(
                "*", dataClass);
        assertThat(pattern.size(), is(1));
        assertThat(pattern.get(0).getKind(), is(SourceKind.CONTEXT));
    }
    ...
    public void resource_complex() {
        ...
        assertThat(pattern.get(0).getTarget().getName(), is(PropertyName.of("stringValue")));
        assertThat(pattern.get(0).getFormat(), is(Format.NATURAL));

        assertThat(pattern.get(1).getKind(), is(SourceKind.NOTHING));
        assertThat(pattern.get(1).getArgument(), is("/${category}-"));

        assertThat(pattern.get(2).getTarget().getName(), is(PropertyName.of("dateValue")));
        ...
        assertThat(pattern.get(6).getKind(), is(SourceKind.CONTEXT));
    ...
    public void order_multiple() {
        ...
        assertThat(pattern.get(1).getTarget().getName(), is(PropertyName.of("stringValue")));
