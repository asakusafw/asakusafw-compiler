...
/**
 * Test for {@link DefaultDataModelLoader}.
 */
public class DefaultDataModelLoaderTest {
    ...
    @Test
    public void simple() {
        DefaultDataModelLoader loader = new DefaultDataModelLoader(getClass().getClassLoader());
