...
public final class MockDataModel implements DataModel<MockDataModel>, Writable {
    ...
    public static class Supplier implements java.util.function.Supplier<MockDataModel> {
        @Override
        public MockDataModel get() {
            return new MockDataModel();
        }
    }

    public static class Copier implements ObjectCopier<MockDataModel> {
        @Override
        public MockDataModel newCopy(MockDataModel source) {
            MockDataModel copy = new MockDataModel();
            copy.copyFrom(source);
            return copy;
        }
    }

    public static class KeyBuilder implements KeyExtractor<MockDataModel> {
        @Override
