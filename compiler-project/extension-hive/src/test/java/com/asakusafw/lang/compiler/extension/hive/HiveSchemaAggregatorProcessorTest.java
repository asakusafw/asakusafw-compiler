...
public class HiveSchemaAggregatorProcessorTest {
    ...
    private void check(HiveInputInfo[] elements) throws IOException {
        check(HiveSchemaAggregatorProcessor.PATH_INPUT, HiveInputInfo.class, Arrays.asList(elements));
    }

    private void check(HiveOutputInfo[] elements) throws IOException {
        check(HiveSchemaAggregatorProcessor.PATH_OUTPUT, HiveOutputInfo.class, Arrays.asList(elements));
    }
