...
/**
 * An abstract super class of bindings for {@link OperatorEstimator} providers.
 */
public abstract class OperatorEstimatorBinding
        extends EngineBinding.Abstract<OperatorEstimator> {
