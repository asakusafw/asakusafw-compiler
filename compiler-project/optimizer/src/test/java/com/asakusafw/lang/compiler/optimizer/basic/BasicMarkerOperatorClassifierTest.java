...
/**
 * Test for {@link BasicMarkerOperatorClassifier}.
 */
public class BasicMarkerOperatorClassifierTest extends OptimizerTestRoot {
    ...
    @Test
    public void simple() {
        OperatorCharacterizer<OperatorClass> engine = new BasicMarkerOperatorClassifier();
        Operator operator = MarkerOperator.builder(typeOf(String.class)).build();
