...
@JobFlow(name = "JobflowWithInvalidInput")
public class JobflowWithInvalidInput extends FlowDescription {

    final In<String> in;

    final Out<String> out;

    public JobflowWithInvalidInput(
            @Import(name = "in", description = InvalidImporterDescription.class) In<String> in,
