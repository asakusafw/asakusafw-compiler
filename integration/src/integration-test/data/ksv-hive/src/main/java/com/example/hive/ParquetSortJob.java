 ...
 */
@JobFlow(name = "parquetSort")
public class ParquetSortJob extends FlowDescription {
    ...
    protected void describe() {
        KsvHiveOperatorFactory op = new KsvHiveOperatorFactory();
        Source<KsvHive> stageIn = checkpoint(op.nop(in).out);
